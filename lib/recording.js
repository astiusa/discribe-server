...
recording.queryExercises = function (id) {
    var d = Q.defer();
...
recording.queryPduStats = function(id, frequency, filter) {
    var d = Q.defer();
    ...
    var pluginName = pluginNames[frequency];
    if (!pluginName) {
    ...
    request.get({
        ...
        uri: '/api/discribe/recordings/'+id+'/pduStats?frequency='+frequency,
        baseUrl: domain
    }, function(err, response, data) {
        if (err) {
            d.reject(err);
...
recording.queryEntities = function(id) {
    var d = Q.defer();

    request.get({
        // uri: '/api/discribe/recordings/'+id+'/entitySummary',   // Commented out for testing
        uri: '/api/discribe/recordings/'+id+'/entities',
        baseUrl: domain,
        encoding: null
    }, function(err, response, data) {
        if (err) {
...
recording.queryTransmissions = function(id) {
    var d = Q.defer();
...
recording.queryPdus = function(id, startTimestamp, endTimestamp) {
    var d = Q.defer();

    request.get({
        //uri: '/api/discribe/recordings/'+id+'/pcap?start='+startTimestamp+'&end='+endTimestamp,
        uri: '/api/discribe/recordings/'+id+'/pdus?start='+startTimestamp+'&end='+endTimestamp,
        baseUrl: domain,
        encoding: null
    }, function(err, response, data) {
        if (err) {
